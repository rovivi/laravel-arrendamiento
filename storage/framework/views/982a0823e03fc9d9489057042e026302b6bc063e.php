  <div class="form-group col-md-12 image" data-preview="#<?php echo e($field['name']); ?>" data-aspectRatio="<?php echo e(isset($field['aspect_ratio']) ? $field['aspect_ratio'] : 0); ?>" data-crop="<?php echo e(isset($field['crop']) ? $field['crop'] : false); ?>" <?php echo $__env->make('crud::inc.field_wrapper_attributes', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>>
    <div>
    ...
    <div class="row">
        <div class="col-sm-6" style="margin-bottom: 20px;">
            <?php if(!is_null(old(square_brackets_to_dots($field['name'])))): ?>
                <img id="mainImage" src="<?php echo e(old(square_brackets_to_dots($field['name']))); ?>">
            <?php elseif(isset($field['src']) && isset($entry)): ?>
                <img id="mainImage" src="<?php echo e($entry->find($entry->id)->{$field['src']}()); ?>">
            <?php elseif(isset($field['value'])): ?>
                <img id="mainImage" src="<?php echo e($field['value']); ?>">
            <?php elseif(isset($field['default'])): ?>
                <img id="mainImage" src="<?php echo e($field['default']); ?>">
            <?php else: ?>
        ...
        <?php endif; ?>
        <input type="hidden" id="hiddenFilename" name="<?php echo e($field['filename']); ?>" value="">
    </div>
    <div class="btn-group">
        <label class="btn btn-primary btn-file">
            Choose file <input type="file" accept="image/*" id="uploadImage" <?php echo $__env->make('crud::inc.field_attributes', ['default_class' => 'hide'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>>
