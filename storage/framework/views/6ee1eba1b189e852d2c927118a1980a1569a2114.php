      ...
      <table class="table table-hover table-condensed">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
                <a class="btn btn-xs btn-default" href="<?php echo e(url(config('backpack.base.route_prefix', 'admin').'/log/preview/'. base64_encode($file['file_name']))); ?>"><i class="fa fa-eye"></i> <?php echo e(trans('backpack::logmanager.preview')); ?></a>
                <a class="btn btn-xs btn-default" href="<?php echo e(url(config('backpack.base.route_prefix', 'admin').'/log/download/'.base64_encode($file['file_name']))); ?>"><i class="fa fa-cloud-download"></i> <?php echo e(trans('backpack::logmanager.download')); ?></a>
                <a class="btn btn-xs btn-danger" data-button-type="delete" href="<?php echo e(url(config('backpack.base.route_prefix', 'admin').'/log/delete/'.base64_encode($file['file_name']))); ?>"><i class="fa fa-trash-o"></i> <?php echo e(trans('backpack::logmanager.delete')); ?></a>
            </td>
          </tr>
