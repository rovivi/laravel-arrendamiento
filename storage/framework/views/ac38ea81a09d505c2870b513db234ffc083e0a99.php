...
https://cdn.datatables.net/fixedheader/3.1.5/js/dataTables.fixedHeader.min.js"></script>
  ...
  <script>
    ...
    var saved_list_url = localStorage.getItem('<?php echo e($crud->entity_name_plural); ?>_list_url');
    if (saved_list_url && saved_list_url!=window.location.href) {
      window.location.href = localStorage.getItem('<?php echo e($crud->entity_name_plural); ?>_list_url');
    }
    <?php endif; ?>
    ...
    var crud = {
      ...
      updateUrl : function (new_url) {
        ...
        localStorage.setItem('<?php echo e($crud->entity_name_plural); ?>_list_url', new_url);
      },
