...
<li filter-name="<?php echo e($filter->name); ?>"
    ...
    <div class="dropdown-menu">
      <div class="form-group backpack-filter m-b-0">
			<select id="filter_<?php echo e($filter->name); ?>" name="filter_<?php echo e($filter->name); ?>" class="form-control input-sm select2" placeholder="<?php echo e($filter->placeholder); ?>">
				<option></option>
